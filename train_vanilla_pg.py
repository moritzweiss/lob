...
env_config = {'total_n_steps': int(1e3), 'log': False, 'seed': None, 'initial_level': 2, 'initial_volume': 10, 'env_type': 'simple'}
...
tuner = tune.Tuner(
    ...
    run_config=air.RunConfig(
        stop={"training_iteration": 100}, storage_path = f"{current}/results",  name = f"{env_config['initial_volume']}_{env_config['env_type']}", 
